...
class TestCommandSpec(unittest.TestCase):
    ...
    def test_normalize_surface_scan_types_accepts_os_fingerprint_aliases(self):
        directives = normalize_surface_scan_types(["os", "fingerprint", "os_fingerprint"])
        self.assertEqual(directives, ("os-fingerprint",))
    ...
    def test_resolve_surface_scan_directives_upgrades_passive_when_active_requested(self):
        ...
        self.assertEqual(directives.scan_types, ("syn", "udp", "os-fingerprint"))
