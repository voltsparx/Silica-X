...
"""Capability source map helpers for Sylica-X."""
...
_FEATURE_DESCRIPTIONS: dict[str, str] = {
    ...
    "signal_fusion_lane": "Unified connector lanes for integrating multi-source intelligence into Sylica workflows.",
...
def map_sources_to_core_modules(
    ...
    """Map source-study strengths to Sylica-X module focus areas."""
...
def write_capability_report(
    output_path: str | Path = "docs/sylica-capability-scan.md",
    *,
...
def _build_plugin_capability_views(
    ...
    *,
    ...
    readme_lines = [
        "# Plugin Intel Views",
        "",
        "Sylica-native plugin recommendations by workflow.",
        "",
...
def _build_filter_capability_views(
    ...
    *,
    ...
    readme_lines = [
        "# Filter Intel Views",
        "",
        "Sylica-native filter recommendations by workflow.",
        "",
...
def build_capability_pack(
    ...
    *,
    ...
    readme_lines = [
        "# Sylica-X Intel",
        "",
        "Generated internal capability intelligence for Sylica-X architecture alignment.",
        "",
        f"- Generated by {PROJECT_NAME} v{VERSION} [{VERSION_THEME}]",
