...
1. Commit grouped changes (see `docs/release-commit-plan-v9.3.0-lattice.md`).
2. Push branch and confirm CI is green.
3. Create annotated tag `v9.3.0`.
4. Publish release with notes from `docs/release-notes-v9.3.0-lattice.md`.
