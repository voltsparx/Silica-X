...
Suggested message:
`feat(core): harden runner, parser, and extension wiring for v9.3.0 lattice`
...
Suggested message:
`docs: publish v9.3.0 lattice usage, release notes, and checklist`
...
- `docs/release-commit-plan-v9.3.0-lattice.md`
