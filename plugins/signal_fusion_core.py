...
"""Plugin: high-fidelity multi-source signal fusion for silinosic_x workflows."""
...
PLUGIN_SPEC = {
    ...
    "description": "Runs internal connector lanes and merges normalized signals into silinosic_x workflows.",
